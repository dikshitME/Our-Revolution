    ...
    return (
       ...
       <div className="w-full  bg-[#FFFFFF]">
         ...
         <div className="text flex gap-[20vw] ml-[7vw] mt-[7vw]">
            <h2 className="text-[1vw] w-[10vw] font-semibold tracking-tighter leading-none">(OUR REVOLUTION) <br />4 January 2023</h2>
            <h1 className="text-[1.5vw] w-[75vw] font-semibold tracking-tighter leading-none">Can Giving Away Ideas For Free Be <br />Valuable?</h1>
            <h2 className="text-[1vw] font-semibold tracking-tighter leading-none">news & opinions <br />(Thought Piece)</h2>
         </div>
         <div className="image w-[95vw]  ml-[2.5vw] mt-[5vw]">
            <img className="w-full h-[55vw]" src="NEWPAGE6.jpg" alt="" />
         </div>
